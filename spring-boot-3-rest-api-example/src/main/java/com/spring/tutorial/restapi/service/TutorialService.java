package com.spring.tutorial.restapi.service;
...
import com.spring.tutorial.restapi.model.Tutorial;
...
public class TutorialService {
  ...
  public List<Tutorial> findByTitleContaining(String title) {
    return tutorials.stream().filter(tutorial -> tutorial.getTitle().contains(title)).collect(Collectors.toList());
  }
  ...
  public List<Tutorial> findByPublished(boolean isPublished) {
    return tutorials.stream().filter(tutorial -> isPublished == tutorial.isPublished()).collect(Collectors.toList());
  }
}
